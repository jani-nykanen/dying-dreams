...
export const PALETTE1 = [
    ...
    TILESET_BLOCK_7, TILESET_BLOCK_8, TILESET_BLOCK_8, TILESET_BLOCK_8,
    // Line 2
    ...
    TILESET_BLOCK_7, TILESET_BLOCK_1, TILESET_BLOCK_1, TILESET_BLOCK_1,
    ...
    FIGURE_BLOCK, FIGURE_BLOCK, FIGURE_BLOCK, FIGURE_BLOCK,
    FIGURE_BLOCK, FIGURE_BLOCK, FIGURE_BLOCK, FIGURE_BLOCK,
    FLAME_1, FLAME_1, ICE_BLOCK, ICE_BLOCK,

    // Line 6
    FIGURE_BLOCK, FIGURE_BLOCK, FIGURE_BLOCK, FIGURE_BLOCK,
    FIGURE_BLOCK, FIGURE_BLOCK, FIGURE_BLOCK, FIGURE_BLOCK,
    FLAME_2, FLAME_1, ICE_BLOCK, ICE_BLOCK
];
